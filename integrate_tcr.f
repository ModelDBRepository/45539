...
! From dienf.                  
       ...
       SUBROUTINE integrate_tcr (O, time, numcell, V, curr,
...
c gamma is function of chi used in calculating KC conductance
       ...
       real*8 totAMPA, totNMDA, totGABA
...
! debuging print of total conductances
!                L=99
!          totAMPA = 0d0
!          totNMDA = 0d0
!          totGABA = 0d0
!       DO I = 1, numcomp
!          totAMPA = totAMPA + gAMPA(I,L)
!          totNMDA = totNMDA + gNMDA(I,L)
!          totGABA = totGABA + gGABA_A(I,L)
!       end do
!       open(30,FILE='data/TCRconductances.dat')
!       write(30,FMT='(3f25.20)') totAMPA, totNMDA, totGABA
